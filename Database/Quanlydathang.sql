...
--
-- Host: 127.0.0.1
-- Generation Time: May 28, 2021 at 01:16 AM
...
(11, 4, NULL, '2021-05-25', NULL, 'processing'),
(12, 4, NULL, '2021-05-25', NULL, 'processing'),
(13, 4, NULL, '2021-05-25', NULL, 'processing'),
(14, 4, NULL, '2021-05-25', NULL, 'processing'),
(15, 4, NULL, '2021-05-25', NULL, 'processing'),
(16, 4, NULL, '2021-05-25', NULL, 'processing'),
(17, 4, NULL, '2021-05-25', NULL, 'processing'),
(18, 4, NULL, '2021-05-26', NULL, 'processing'),
(19, 4, NULL, '2021-05-26', NULL, 'processing'),
(20, 4, NULL, '2021-05-26', NULL, 'processing'),
(21, 4, NULL, '2021-05-28', NULL, 'processing'),
(22, 4, NULL, '2021-05-28', NULL, 'processing'),
(23, 4, NULL, '2021-05-28', NULL, 'processing'),
(24, 4, NULL, '2021-05-28', NULL, 'processing'),
(25, 4, NULL, '2021-05-28', NULL, 'processing'),
(26, 4, NULL, '2021-05-28', NULL, 'processing'),
(27, 4, NULL, '2021-05-28', NULL, 'processing'),
(28, 4, NULL, '2021-05-28', NULL, 'processing');
...
(1, 'Thành Phố Hồ Chí Minh', 4),
(2, 'Xuân Khánh, Ninh Kiều, Cần Thơ', 4);
...
(39, 'CẨM NANG MUA BÁN ĐẤT', '/ShopPlus_Customer/assets/images/products/f797420579b8e0f5c84a1278d23053ec.jpg', 'quyển', 150000, 1, 1, ''),
...
(49, 'Ổ Cứng SSD Kingston A400 (240GB) - Hàng Chính Hãng', '/ShopPlus_Customer/assets/images/products/9df3937c390fcc0b66161f4dbe783757.jpg', 'cái', 815000, 5, 2, ''),
...
(56, 'Điện Thoại Vsmart Live 4 (6GB/64GB) - Hàng Chính H', '/ShopPlus_Customer/assets/images/products/3360d9dcb541dd5d2aaa59ae0ad6b1c5.jpg', 'cái', 3489000, 5, 4, ''),
...
(4, 'Hoang Linh Nguyen', 'hlp', '0123456789', 'dev777@gmail.com'),
(5, 'Hoang Linh Nguyen', 'upl', '0123456789', 'linh072217@gmail.com'),
(7, 'Võ Thị Ngọc Thư', '', '01234233333', 'vongocthu0719@gmail.com'),
...
--
ALTER TABLE `dathang`
  MODIFY `SODONDH` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
DELIMITER $$
CREATE DEFINER=`root`@`localhost` FUNCTION `STAFF_LOGIN`(id int) RETURNS tinyint(1)
begin
